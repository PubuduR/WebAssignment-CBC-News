...
<ul>
  ...
  <table align="right" style="width:75%" cellspacing="10">
    ...
    <table border="1"><tr><td><img src="select.png" align="center" width="40" height="40"><td width="360">User name</td><td width="360">Email ID</td>
...
<td><h4><a href="delete.php">Delete</a></td><td><a href="delete.php"><img src="pencil.png" width="40" height="40"></a></h4></td></tr>
  ...
  <td><h4><a href="messages.php">Messages</a></td><td><a href="users.php"><img src="message.png" width="40" height="40"></a></h4></td></tr> 
        </table>
      </div>
